...
class MjContactWrapper(util.WrapperBase):
  ...
  def solimp(self):
    ...
    return util.buf_to_npy(self._ptr.contents.solimp, (3,))

  @property
  def mu(self):
    """friction of regularized cone, set by mj_makeR."""
  ...
  @property
  def exclude(self):
    """0: include, 1: in gap, 2: fused, 3: equality."""
...
class MjDataWrapper(util.WrapperBase):
  ...
  def warning(self):
    """warning statistics."""
    return self._ptr.contents.warning

  @property
  def timer(self):
    """timer statistics."""
    return self._ptr.contents.timer
  ...
  @util.CachedProperty
  def ten_moment(self):
    """tendon moment arms (ntendon x nv)."""
    return util.buf_to_npy(self._ptr.contents.ten_moment,
  ...
  def efc_J_colind(self):
    """column indices in sparse Jacobian (njmax x nv)."""
  ...
  def efc_JT_colind(self):
    """column indices in sparse Jacobian T (nv x njmax)."""
    return util.buf_to_npy(self._ptr.contents.efc_JT_colind,
                           (self._model.nv, self._model.njmax))

  @util.CachedProperty
  def efc_solref(self):
    """constraint solver reference (njmax x mjNREF)."""
    return util.buf_to_npy(self._ptr.contents.efc_solref,
                           (self._model.njmax, 2))

  @util.CachedProperty
  def efc_solimp(self):
    """constraint solver impedance (njmax x mjNIMP)."""
    return util.buf_to_npy(self._ptr.contents.efc_solimp,
                           (self._model.njmax, 3))
  ...
  @util.CachedProperty
  def efc_JT(self):
    """sparse constraint Jacobian transposed (nv x njmax)."""
...
class MjOptionWrapper(util.WrapperBase):
  ...
  def o_solimp(self):
    """solimp."""
    return util.buf_to_npy(self._ptr.contents.o_solimp, (3,))
  ...
  @property
  def impedance(self):
    """how to interpret solimp (mjtImp)."""
    return self._ptr.contents.impedance

  @impedance.setter
  def impedance(self, value):
    self._ptr.contents.impedance = value

  @property
  def reference(self):
    """how to interpret solref (mjtRef)."""
    return self._ptr.contents.reference

  @reference.setter
  def reference(self, value):
    self._ptr.contents.reference = value
...
class QualityWrapper(util.WrapperBase):
  ...
  @property
  def numslices(self):
    """number of slices for Glu drawing."""
  ...
  @property
  def numstacks(self):
    """number of stacks for Glu drawing."""
  ...
  @property
  def numarrows(self):
    """number of arrows for torque rendering."""
    return self._ptr.contents.numarrows

  @numarrows.setter
  def numarrows(self, value):
    self._ptr.contents.numarrows = value
...
class MjModelWrapper(util.WrapperBase):
  ...
  def dof_invweight0(self):
    """inv. diag. inertia in qpos0 (nv x 1)."""
  ...
  @util.CachedProperty
  def mesh_vert(self):
    """vertex data for all meshes (nmeshvert x 3)."""
    return util.buf_to_npy(self._ptr.contents.mesh_vert,
                           (self.nmeshvert, 3))

  @util.CachedProperty
  def mesh_normal(self):
    """vertex normal data for all meshes (nmeshvert x 3)."""
  ...
  def actuator_invweight0(self):
    """inv. weight in qpos0 (nu x 1)."""
    return util.buf_to_npy(self._ptr.contents.actuator_invweight0,
                           (self.nu,))
...
class MjvOptionWrapper(util.WrapperBase):
  ...
  def geomgroup(self):
    ...
    return util.buf_to_npy(self._ptr.contents.geomgroup, (5,))

  @util.CachedProperty
  def sitegroup(self):
    """site visualization by group."""
    return util.buf_to_npy(self._ptr.contents.sitegroup, (5,))

  @util.CachedProperty
  def flags(self):
    """visualization flags (indexed by mjtVisFlag)."""
    return util.buf_to_npy(self._ptr.contents.flags, (18,))
...
class MjvSceneWrapper(util.WrapperBase):
  ...
  def lights(self):
    """buffer for lights."""
    return self._ptr.contents.lights
  ...
  def flags(self):
    ...
    return util.buf_to_npy(self._ptr.contents.flags, (5,))
...
class MjvFigureWrapper(util.WrapperBase):
  ...
  def linedata(self):
    """line data (x,y)."""
    return util.buf_to_npy(self._ptr.contents.linedata, (100, 1000))
