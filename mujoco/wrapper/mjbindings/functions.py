...
Returns:
  ctypes.c_int
"""
mjlib.mj_activate.argtypes = [ctypes.POINTER(ctypes.c_char)]
...
Returns:
  None
"""
mjlib.mj_certQuestion.argtypes = [util.ndptr(shape=(16,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  None
"""
mjlib.mj_defaultVFS.argtypes = [ctypes.POINTER(MJVFS)]
...
Returns:
  None
"""
mjlib.mj_deleteVFS.argtypes = [ctypes.POINTER(MJVFS)]
...
Returns:
  None
"""
mjlib.mj_defaultOption.argtypes = [ctypes.POINTER(MJOPTION)]
...
Returns:
  None
"""
mjlib.mj_defaultVisual.argtypes = [ctypes.POINTER(MJVISUAL)]
...
Returns:
  None
"""
mjlib.mj_deleteModel.argtypes = [ctypes.POINTER(MJMODEL)]
...
Returns:
  ctypes.c_int
"""
mjlib.mj_sizeModel.argtypes = [ctypes.POINTER(MJMODEL)]
...
Returns:
  ctypes.POINTER(MJDATA)
"""
mjlib.mj_makeData.argtypes = [ctypes.POINTER(MJMODEL)]
...
Returns:
  None
"""
mjlib.mj_deleteData.argtypes = [ctypes.POINTER(MJDATA)]
mjlib.mj_deleteData.restype = None

mjlib.mj_setConst.__doc__ = """
Set constant fields of mjModel, corresponding to qpos0 configuration.. The flag
flg_actrange currently has no effect..

Args:
  m: ctypes.POINTER(MJMODEL)
  d: ctypes.POINTER(MJDATA)
  flg_actrange: ctypes.c_int
Returns:
  None
"""
...
Returns:
  ctypes.c_int
"""
mjlib.mj_isPyramidal.argtypes = [ctypes.POINTER(MJMODEL)]
...
Returns:
  ctypes.c_int
"""
mjlib.mj_isSparse.argtypes = [ctypes.POINTER(MJMODEL)]
...
Returns:
  ctypes.c_int
"""
mjlib.mj_isDual.argtypes = [ctypes.POINTER(MJMODEL)]
...
Args:
  ...
  id_: ctypes.c_int
Returns:
  ctypes.POINTER(ctypes.c_char) <const>
"""
...
Returns:
  ctypes.c_double
"""
mjlib.mj_getTotalmass.argtypes = [ctypes.POINTER(MJMODEL)]
...
bodyexclude.. Return geomid and distance (x) to nearest surface, or -1 if no
intersection.. geomgroup, flg_static are as in mjvOption; geomgroup==NULL skips
group exclusion..
...
Returns:
  None
"""
mjlib.mjv_defaultCamera.argtypes = [ctypes.POINTER(MJVCAMERA)]
...
Returns:
  None
"""
mjlib.mjv_defaultPerturb.argtypes = [ctypes.POINTER(MJVPERTURB)]
...
Returns:
  ctypes.c_double
"""
mjlib.mjv_frustumHeight.argtypes = [ctypes.POINTER(MJVSCENE)]
...
Select model geom with mouse, return -1 if none selected. selpnt is the 3D
point..
...
Returns:
  None
"""
mjlib.mjv_defaultOption.argtypes = [ctypes.POINTER(MJVOPTION)]
...
Returns:
  None
"""
mjlib.mjv_defaultFigure.argtypes = [ctypes.POINTER(MJVFIGURE)]
...
Returns:
  None
"""
mjlib.mjv_freeScene.argtypes = [ctypes.POINTER(MJVSCENE)]
...
Returns:
  None
"""
mjlib.mjr_defaultContext.argtypes = [ctypes.POINTER(MJRCONTEXT)]
...
Returns:
  None
"""
mjlib.mjr_freeContext.argtypes = [ctypes.POINTER(MJRCONTEXT)]
...
Set OpenGL framebuffer for rendering: mjFB_WINDOW or mjFB_OFFSCREEN.. If only
one buffer is available, set that buffer and ignore framebuffer argument..
...
Returns:
  MJRRECT
"""
mjlib.mjr_maxViewport.argtypes = [ctypes.POINTER(MJRCONTEXT)]
...
Args:
  viewport: MJRRECT
  fig: ctypes.POINTER(MJVFIGURE) <const>
  con: ctypes.POINTER(MJRCONTEXT) <const>
Returns:
  None
"""
...
Returns:
  None
"""
mjlib.mju_error.argtypes = [ctypes.POINTER(ctypes.c_char)]
...
Returns:
  None
"""
mjlib.mju_warning.argtypes = [ctypes.POINTER(ctypes.c_char)]
...
Returns:
  ctypes.c_void_p
"""
mjlib.mju_malloc.argtypes = [ctypes.c_size_t]
...
Returns:
  None
"""
mjlib.mju_free.argtypes = [ctypes.c_void_p]
...
Returns:
  None
"""
mjlib.mju_zero3.argtypes = [util.ndptr(shape=(3,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  ctypes.c_double
"""
mjlib.mju_normalize3.argtypes = [util.ndptr(shape=(3,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  ctypes.c_double
"""
mjlib.mju_norm3.argtypes = [util.ndptr(shape=(3,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  None
"""
mjlib.mju_zero4.argtypes = [util.ndptr(shape=(4,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  None
"""
mjlib.mju_unit4.argtypes = [util.ndptr(shape=(4,), dtype=np.float64, flags=('C', 'W'))]
...
Returns:
  ctypes.c_double
"""
mjlib.mju_normalize4.argtypes = [util.ndptr(shape=(4,), dtype=np.float64, flags=('C', 'W'))]
...
mjlib.mju_dotSparse.__doc__ = """
Return dot-product of vec1 and vec2, where vec1 is sparse..

Args:
  vec1: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  vec2: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  nnz1: ctypes.c_int <const>
  ind1: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
Returns:
  ctypes.c_double
"""
mjlib.mju_dotSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    util.ndptr(dtype=np.intc, flags=('C', 'W'))
]
mjlib.mju_dotSparse.restype = ctypes.c_double

mjlib.mju_dotSparse2.__doc__ = """
...
Args:
  ...
  nnz1: ctypes.c_int <const>
  ind1: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  nnz2: ctypes.c_int <const>
  ind2: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
Returns:
  ctypes.c_double
"""
mjlib.mju_dotSparse2.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    util.ndptr(dtype=np.intc, flags=('C', 'W')),
...
mjlib.mju_dotSparse2.restype = ctypes.c_double

mjlib.mju_dense2sparse.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_dense2sparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_int,
...
mjlib.mju_dense2sparse.restype = None

mjlib.mju_sparse2dense.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_sparse2dense.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_int,
...
mjlib.mju_sparse2dense.restype = None

mjlib.mju_mulMatVecSparse.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_mulMatVecSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
...
mjlib.mju_mulMatVecSparse.restype = None

mjlib.mju_compressSparse.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_compressSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_int,
    util.ndptr(dtype=np.intc, flags=('C', 'W')),
...
mjlib.mju_compressSparse.restype = None

mjlib.mju_combineSparse.__doc__ = """
Set dst = a*dst + b*src, return nnz of result, modify dst sparsity pattern as
needed.. Both vectors are sparse. The required scratch space is 2*n..

Args:
  dst: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  src: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  n: ctypes.c_int
  a: ctypes.c_double
  b: ctypes.c_double
  dst_nnz: ctypes.c_int
  src_nnz: ctypes.c_int
  dst_ind: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  src_ind: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  scratch: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  nscratch: ctypes.c_int
Returns:
  ctypes.c_int
"""
mjlib.mju_combineSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_double,
...
mjlib.mju_combineSparse.restype = ctypes.c_int

mjlib.mju_sqrMatTDSparse.__doc__ = """
Set res = matT * diag * mat if diag is not NULL, and res = matT * mat
otherwise.. The required scratch space is 3*nc. The result has uncompressed
layout..

Args:
  res: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  mat: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  matT: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  diag: util.ndptr(dtype=np.float64, flags=('C', 'W')) <const>
  nr: ctypes.c_int
  nc: ctypes.c_int
  res_rownnz: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  res_rowadr: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  res_colind: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  rownnz: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  rowadr: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  colind: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  rownnzT: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  rowadrT: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  colindT: util.ndptr(dtype=np.intc, flags=('C', 'W')) <const>
  scratch: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  nscratch: ctypes.c_int
Returns:
  None
"""
mjlib.mju_sqrMatTDSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
...
mjlib.mju_sqrMatTDSparse.restype = None

mjlib.mju_transposeSparse.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_transposeSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_int,
...
mjlib.mju_transposeSparse.restype = None
...
mjlib.mju_cholFactorSparse.__doc__ = """
Sparse reverse-order Cholesky decomposition: mat = L'*L; return 'rank'.. mat
must have uncompressed layout; rownnz is modified to end at diagonal.. The
required scratch space is 2*n..
...
Returns:
  ctypes.c_int
"""
mjlib.mju_cholFactorSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    util.ndptr(dtype=np.intc, flags=('C', 'W')),
    util.ndptr(dtype=np.intc, flags=('C', 'W')),
...
mjlib.mju_cholFactorSparse.restype = ctypes.c_int

mjlib.mju_cholSolveSparse.__doc__ = """
...
Returns:
  None
"""
mjlib.mju_cholSolveSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
...
mjlib.mju_cholSolveSparse.restype = None

mjlib.mju_cholUpdateSparse.__doc__ = """
Sparse reverse-order Cholesky rank-one update: L'*L +/- x*x'; return rank.. The
vector x is sparse; changes in sparsity pattern of mat are not allowed.. The
required scratch space is 2*n..
...
Args:
  ...
  colind: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  x_nnz: ctypes.c_int
  x_ind: util.ndptr(dtype=np.intc, flags=('C', 'W'))
  scratch: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  nscratch: ctypes.c_int
Returns:
  ctypes.c_int
"""
mjlib.mju_cholUpdateSparse.argtypes = [
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
    ctypes.c_int,
    ctypes.c_int,
...
mjlib.mju_cholUpdateSparse.restype = ctypes.c_int
...
mjlib.mju_muscleFVL.__doc__ = """
Muscle model; not yet implemented..

Args:
  len_: ctypes.c_double
  vel: ctypes.c_double
  lmin: ctypes.c_double
  lmax: ctypes.c_double
  prm: util.ndptr(dtype=np.float64, flags=('C', 'W'))
Returns:
  ctypes.c_double
"""
mjlib.mju_muscleFVL.argtypes = [
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
...
mjlib.mju_muscleFVL.restype = ctypes.c_double

mjlib.mju_musclePassive.__doc__ = """
...
Returns:
  ctypes.c_double
"""
mjlib.mju_musclePassive.argtypes = [
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
    util.ndptr(dtype=np.float64, flags=('C', 'W'))
]
mjlib.mju_musclePassive.restype = ctypes.c_double

mjlib.mju_pneumatic.__doc__ = """
Pneumatic cylinder dynamics; not yet implemented..

Args:
  len_: ctypes.c_double
  len0: ctypes.c_double
  vel: ctypes.c_double
  prm: util.ndptr(dtype=np.float64, flags=('C', 'W'))
  act: ctypes.c_double
  ctrl: ctypes.c_double
  timestep: ctypes.c_double
  jac: util.ndptr(dtype=np.float64, flags=('C', 'W'))
Returns:
  ctypes.c_double
"""
mjlib.mju_pneumatic.argtypes = [
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
    util.ndptr(dtype=np.float64, flags=('C', 'W')),
...
mjlib.mju_pneumatic.restype = ctypes.c_double
...
Returns:
  ctypes.c_double
"""
mjlib.mju_sign.argtypes = [ctypes.c_double]
...
Returns:
  ctypes.c_int
"""
mjlib.mju_round.argtypes = [ctypes.c_double]
...
Returns:
  ctypes.POINTER(ctypes.c_char) <const>
"""
mjlib.mju_type2Str.argtypes = [ctypes.c_int]
...
Returns:
  ctypes.c_int
"""
mjlib.mju_str2Type.argtypes = [ctypes.POINTER(ctypes.c_char)]
...
Returns:
  ctypes.c_int
"""
mjlib.mju_isBad.argtypes = [ctypes.c_double]
...
Returns:
  ctypes.c_double
"""
mjlib.mju_standardNormal.argtypes = [util.ndptr(dtype=np.float64, flags=('C', 'W'))]
...
mjLABELSTRING = (ctypes.c_char_p * 13).in_dll(mjlib, 'mjLABELSTRING')
mjFRAMESTRING = (ctypes.c_char_p * 7).in_dll(mjlib, 'mjFRAMESTRING')
mjVISSTRING = ((ctypes.c_char_p * 3) * 18).in_dll(mjlib, 'mjVISSTRING')
mjRNDSTRING = ((ctypes.c_char_p * 3) * 5).in_dll(mjlib, 'mjRNDSTRING')
...
function_pointers = collections.namedtuple(
  ...
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_sol_imp'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_sol_ref'))
