...
class MJDATA(ctypes.Structure):
  ...
  _fields_ = [
      ...
      ('ten_moment', ctypes.POINTER(ctypes.c_double)),
      ...
      ('efc_solref', ctypes.POINTER(ctypes.c_double)),
      ('efc_solimp', ctypes.POINTER(ctypes.c_double)),
...
class MJMODEL(ctypes.Structure):
  ...
  _fields_ = [
      ...
      ('actuator_invweight0', ctypes.POINTER(ctypes.c_double)),
...
class MJVOPTION(ctypes.Structure):
  ...
  _fields_ = [
      ('label', ctypes.c_int),
      ('frame', ctypes.c_int),
      ('geomgroup', ctypes.c_ubyte * (5)),
      ('sitegroup', ctypes.c_ubyte * (5)),
      ('flags', ctypes.c_ubyte * (18))
  ]
...
class MJVFIGURE(ctypes.Structure):
  ...
  _fields_ = [
      ...
      ('linedata', ctypes.c_float * (100 * 1000)),
